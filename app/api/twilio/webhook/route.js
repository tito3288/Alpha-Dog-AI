...
export async function POST(req) {
    try {
        ...
        if (["no-answer", "busy", "failed", "completed"].includes(CallStatus.toLowerCase())) {
            ...
            console.log(`🟢 Logging missed call for CallSid: ${CallSid}, Status: ${CallStatus}`);
            ...
            console.log(`📩 Attempting to trigger AI Follow-up SMS for ${clinicName}, CallStatus: ${CallStatus}`);
            ...
            console.log(`🔄 Fetch request sent to send-followup. Waiting for response...`);
        ...
        twiml.record({
            maxLength: 30,
            action: "https://f910-69-174-154-43.ngrok-free.app/api/twilio/handle-recording",
        });
